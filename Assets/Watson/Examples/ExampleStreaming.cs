...
namespace IBM.Watsson.Examples
{
    public class ExampleStreaming : MonoBehaviour
    {
        ...
        private IEnumerator CreateService()
        {
            ...
            //  Create LanguageTranslator
            //Authenticator languageTranslatorAuthenticator = new IamAuthenticator(apikey: "");
            //while (!languageTranslatorAuthenticator.CanAuthenticate())
            //    yield return null;

            //languageTranslatorService = new LanguageTranslatorService("2019-11-08", languageTranslatorAuthenticator);
            ...
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        // Translate!
                        //languageTranslatorService.Translate(OnTranslate, new List<string> { alt.transcript }, "en-es");
                    }
